...
export const InfoschematicRenderersContext =
  createContext<InfoschematicRenderers>(noRenderers);

export const useInfoschematicRenderers = () =>
  useContext(InfoschematicRenderersContext);
