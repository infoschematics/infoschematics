...
describe('Canvas visual tokens', () => {
  it('consumes only generated custom properties for shared CSS decisions', async () => {
    ...
    expect(cssValue(generated, '--infoschematic-canvas-surfaces-backdrop')).toBe(visualTokens.canvas.surfaces.backdrop)
    ...
    expect(styles).toContain('.infoschematic-svg.surface-neutral .infoschematic-backdrop')
