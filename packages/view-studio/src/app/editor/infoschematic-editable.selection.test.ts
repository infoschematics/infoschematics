...
import { moveArtefactOperation, resizeArtefactOperation } from '@infoschematics/view-model/editable'
...
describe('Infoschematic editable selection adapter', () => {
  ...
  it('returns kind capabilities and refuses generic Flow move or resize', () => {
    ...
    expect(flow && moveArtefactOperation(flow.selection, flow.geometry, { dx: 10, dy: 10 })).toBeUndefined()
    expect(flow && resizeArtefactOperation(flow.selection, flow.geometry, { height: 40, width: 40 })).toBeUndefined()
  })
