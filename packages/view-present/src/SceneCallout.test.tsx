...
const runtime = createInfoschematicRuntime(defineInfoschematic({ title: 'Callout renderer test' }))
      ...
      callouts: [
        {
          ...
          component: ({ children }: { children: ReactNode }) => <div data-custom-callout>{children}</div>
        }
      ],
      onDiagnostic
    })
