...
The [`examples/is-blank`](https://github.com/infoschematics/infoschematics/tree/main/examples/is-blank/) package is the minimum executable reference, hosted at `/examples/blank/`. [`examples/is-infoschematics`](https://github.com/infoschematics/infoschematics/tree/main/examples/is-infoschematics/) owns both the substantial self-description mounted in Studio at `/examples/infoschematics/` and the concise overview rendered as deterministic SVG on the homepage.
