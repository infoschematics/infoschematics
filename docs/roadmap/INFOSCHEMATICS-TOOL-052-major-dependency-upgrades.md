...
- [ ] Assess the TypeScript 6.x migration notes and the 7.x native-port consequences before choosing whether to land on 6.x first or go directly to 7.x, and record which and why.
