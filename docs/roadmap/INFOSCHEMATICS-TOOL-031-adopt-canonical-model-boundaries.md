...
- `bun run self:check` exits 0: 71 test files and 486 tests pass, every TypeScript workspace compiles, dependency boundaries pass across 372 modules and 1,164 dependencies, generated artefacts are current, and the production Site builds.
