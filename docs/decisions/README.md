...
36. [GDR-INFOSCHEMATICS-004](GDR-INFOSCHEMATICS-004-promise-the-active-lts-node-line.md) — promise the Active LTS Node line in every manifest and type against the same line.
