...
[`ADR-INFOSCHEMATICS-032`](ADR-INFOSCHEMATICS-032-a-point-is-created-from-the-library.md) later reversed the non-creatability consequence above and corrected its closing claim about Card, Fabric and Flow. Everything else this record decided stands.
