...
[`ADR-INFOSCHEMATICS-024`](ADR-INFOSCHEMATICS-024-name-dynamics-in-the-document.md) generalises this occurrence contract to named authored Dynamics without changing it: a resolved Flow signal is the same occurrence a host could have supplied directly.
