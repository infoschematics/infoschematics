...
These guides explain how to operate and maintain the Infoschematics repository. Product decisions explain why in [`docs/decisions/`](../decisions/README.md), Specifications define the accepted contract in [`docs/specs/`](../specs/README.md), and roadmap records track delivery in [`docs/roadmap/`](../roadmap/).
