...
The public website is an outlet for this repository, not an owner of product behaviour. Preserve the designed homepage, keep authored Infoschematics independent, and place reusable capability in Domain Model, View Model or an appropriate View package before consuming it from the site.
